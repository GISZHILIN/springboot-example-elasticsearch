package com.example.elasticsearch.core.result.advice;
...
public class CustomResponseDataAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter methodParameter, MediaType mediaType, Class<? extends HttpMessageConverter<?>> aClass, ServerHttpRequest serverHttpRequest, ServerHttpResponse serverHttpResponse) {
        ...
        Long expireTime = System.currentTimeMillis() - WebUtil.getParam();
        if(body != null && (body instanceof File)){
            ...
            ResResult resResult = new ResResult(path, body, expireTime);
